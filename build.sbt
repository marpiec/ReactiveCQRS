...
val postgresAkkaPersistence = project.in(file("postgres-akka-persistence")).dependsOn(core).dependsOn(utils)
...
val prototype = project.in(file("prototype")).dependsOn(postgresAkkaPersistence)